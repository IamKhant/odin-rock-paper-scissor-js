...
function playGame() {
  ...
  function playRound(humanChoice, computerChoice) {
    if (humanChoice === computerChoice) {
      ...
      humanScore++;
      console.log("Human wins!" + humanChoice + " beats " + computerChoice + ". Human current score: " + humanScore);
    } else {

      computerScore++;
      console.log("Computer wins! " + computerChoice + " beats " + humanChoice + ". Computer current score: " + computerScore);
    }
  }
